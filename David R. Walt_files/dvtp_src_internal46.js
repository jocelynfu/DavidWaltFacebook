...
try {
	...
	dv_handler89.prototype = dv_baseHandlerIns;
dv_handler89.prototype.constructor = dv_handler89;

    var dv_handlersDefs = [{handler: new dv_handler89(), minRate: 0, maxRate: 90}];
